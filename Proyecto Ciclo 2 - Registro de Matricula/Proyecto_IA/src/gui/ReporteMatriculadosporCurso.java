...
public class ReporteMatriculadosporCurso extends JDialog implements ActionListener {
	...
	public ReporteMatriculadosporCurso() {
		...
		lblNewLabel.setIcon(new ImageIcon(ReporteMatriculadosporCurso.class.getResource("/imagenes/fondoframes.jpg")));
