...
public class ReporteAlumnosMatriculaPendente extends JDialog implements ActionListener {
	...
	public static void main(String[] args) {
		try {
			ReporteAlumnosMatriculaPendente dialog = new ReporteAlumnosMatriculaPendente();
	 ...
	 * Create the dialog.
	 */
	public ReporteAlumnosMatriculaPendente() {
		...
		lblNewLabel.setIcon(new ImageIcon(ReporteAlumnosMatriculaPendente.class.getResource("/imagenes/fondoframes.jpg")));
