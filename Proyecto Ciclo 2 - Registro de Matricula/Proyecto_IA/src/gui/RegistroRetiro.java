...
public class RegistroRetiro extends JDialog implements ItemListener, ActionListener, MouseListener {
	...
	public RegistroRetiro() {
		...
		btnAceptar.setBounds(565, 127, 110, 33);
		...
		btnCancelar.setBounds(565, 181, 110, 33);
		...
		btnAdicionar.setBounds(635, 63, 104, 33);
		...
		btnModificar.setBounds(691, 127, 104, 33);
		...
		btnEliminar.setBounds(691, 183, 104, 33);
		getContentPane().add(btnEliminar);
		
		scrollPane = new JScrollPane();
		scrollPane.setBounds(10, 239, 816, 228);
		...
		lblNewLabel_7.setIcon(new ImageIcon(RegistroRetiro.class.getResource("/imagenes/fondoframes.jpg")));
		lblNewLabel_7.setBounds(0, 0, 834, 475);
			...
			try {
				...
				if (!btnAdicionar.isEnabled()) {
					if (aa.buscar(am.buscar(numMatricula).getCodigoAlumno()).getEstado() == 1) {
						Retiro nuevo = new Retiro(numRetiro, numMatricula, FechaHora.fechaActual(), FechaHora.horaActual());
