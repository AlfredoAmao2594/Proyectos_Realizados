...
public class MantenimientoCurso extends JDialog implements ActionListener, ItemListener, MouseListener {
	...
	public MantenimientoCurso() {
		...
		lblNewLabel_5.setBounds(195, 127, 54, 15);
		...
		btnAceptar.setBounds(491, 32, 142, 27);
		getContentPane().add(btnAceptar);
		
		btnCancelar = new JButton("Cancelar");
		btnCancelar.addActionListener(this);
		btnCancelar.setFont(new Font("Tahoma", Font.PLAIN, 12));
		btnCancelar.setBounds(442, 127, 120, 33);
		getContentPane().add(btnCancelar);
		
		btnAdicionar = new JButton("Adicionar");
		btnAdicionar.addActionListener(this);
		btnAdicionar.setFont(new Font("Tahoma", Font.PLAIN, 12));
		btnAdicionar.setBounds(442, 83, 120, 33);
		...
		btnEliminar.setBounds(572, 127, 104, 33);
		...
		lblNewLabel.setIcon(new ImageIcon(MantenimientoCurso.class.getResource("/imagenes/fondoframes.jpg")));
