				...
				<input type="hidden" name="opcion" value="modificar">
					<table>
						<tr>
							<td>Id de Cliente</td>
							<td>
								<input type="text" name="id" required="required" readonly="readonly" value="<c:out value="${objCliente.id }" escapeXml="true"/>">
							</td>
						</tr>
						<tr>
							<td>Nombres</td>
						...
						<tr id="btnAccion">
							<td></td>
							<td></td>
							<td align="center"><input type="submit" value="Modificar" class="boton"></td>
						</tr>
					</table>
